...
function verifyPart(part) {
  ...
  if (["content", "tag", "placeholder"].indexOf(part.type) === -1) {
    errMessage = "part has invalid type : '".concat(part.type, "'");
  }
  if (errMessage) {
    console.log(JSON.stringify({
      msg: "inspect-part",
  ...
  return _createClass(AssertionModule, [{
    ...
    value: function on(eventName) {
      if (eventName === "after-parse" && this.docxtemplater) {
        var compiled = this.docxtemplater.compiled;
        for (var key in compiled) {
          var parsed = compiled[key].parsed;
